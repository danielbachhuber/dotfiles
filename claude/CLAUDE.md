...
- Whenever you prepare a PR description, PR comment, issue body, or issue comment on my behalf, first write the content to a markdown file in the working directory so I can easily access and edit it before anything is posted. Don't post to GitHub until I've confirmed.
